...
public class ModuleService {
    ...
    public void createModule() {
        if (!"ADMIN".equalsIgnoreCase(currentUserRole)) {
            System.out.println("Permission denied: Only ADMIN can manage modules.");
            return;
        }
     ...
     * @return String array of module data or null if not found
     */
    ...
    /**
     * Get all modules led by a specific MO
     * @param leaderId The student ID of the MO
     * @return List of module data arrays
     */
    public List<String[]> getModulesByLeader(String leaderId) {
        List<String[]> data = FileUtil.readCSV(FILE_PATH);
        List<String[]> result = new ArrayList<>();
        for (int i = 1; i < data.size(); i++) {
            if (data.get(i)[2].equalsIgnoreCase(leaderId)) {
