     ...
     public void upload() { 
         ...
         for (int i = 1; i < userData.size(); i++) { // Skip header 
             ...
             if (user.length > 0 && user[0].equals(studentId)) { 
                 ...
                 // Permission Check: Only TA can upload CV
                 String role = (user.length > 8) ? user[8] : "TA";
                 if (!role.equals("TA")) {
                     System.out.println("------------------------------------------"); 
                     System.out.println("Access Denied: Only users with 'TA' role can upload CV.");
                     System.out.println("Your current role is: " + role);
                     System.out.println("------------------------------------------"); 
                     break;
                 }
                 ...
                 // Prepare updated user record with 9 fields: 
                 ...
                 updatedUser[8] = (user.length > 8) ? user[8] : "TA";
                 ...
                 if (header.length < 9) { 
                     ...
                     if (header.length <= 8) newHeader[8] = "role";
